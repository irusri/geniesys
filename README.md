...
👍  GenIE-Sys is available on [http://localhost/geniesys/](http://localhost/geniesys/) URL and follow the  [documentation](https://app.gitbook.com/@geniesys/s/geniesys/for-administrators/installation).
