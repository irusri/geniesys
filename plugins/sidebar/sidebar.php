   ...
   <li id="genelistli" style="list-style-type: none;">
      <ul id="numberofgenesSpanDetail" class="notifi">
         <div id="content" style="font-weight:bold">
            <?php include( "plugins/genelist/baskets/listbarang.php");?>
         </div>
         <div id="Formcontent"></div>
         <span class="hint--bottom" aria-label="Add new GeneList"> <a href="<?php print $GLOBALS['base_url']?>/plugins/genelist/baskets/formbarang.php?action=add" class="add"><i class="savemenu fa-plus"></i></a></span> &nbsp;<span class="hint--bottom" aria-label="Duplicate selected GeneList"><a href="<?php print $GLOBALS['base_url']?>/plugins/genelist/baskets/formbarang.php?action=savecurent"
            class="savecurrent"><i class="savemenu fa-copy"></i></a></span> &nbsp; <span id="cancelbtn" class="hint--right" aria-label="Cancel" style="display:none"><a href="<?php print $GLOBALS['base_url']?>/plugins/genelist/baskets/formbarang.php?action=add" class="cancel"><i class="savemenu fa-ban"></i></a></span> 
      </ul>
   </li>
