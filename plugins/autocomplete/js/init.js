    ...
    $( "#mainsearch" ).catcomplete({
      ...
      minLength: 2,
        select: function( event, ui ) {
		  ...
		  if(ui.item.label.substring(0,2)=="MA" || ui.item.label.substring(0,2)=="PI" || ui.item.label.substring(0,2)=="po"){
...
input.addEventListener("keyup", function(event) {
  ...
  if (event.keyCode === 13) {
    ...
    // Trigger the button element with a click
	  ...
	  if(tmp_v.substring(0,2)=="MA" || tmp_v.substring(0,2)=="PI" || tmp_v.substring(0,2)=="Po"){
