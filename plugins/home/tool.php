...
<body>
<div class="genie-modal--tracking-intro genie-state-01">
  <!--<button class="genie-modal-close"><i class="material-icons">close</i></button>-->
  <div class="genie-illustration">
    <div class="genie-illustration--rainbow">
...
´		<div style="width: 100%;height: 300px;position: absolute;overflow: hidden background: blue;display: none;" id="first"></div>
    ...
    <div class="genie-button-group-container" style="display: none">
      <div class="genie-button-group">
        <button id="btn-left" class="genie-button-disabled"><i class="material-icons">chevron_left</i></button>
