/**
 * Draggable points plugin for Popcharts JS
 * Author: Torstein Honsi
 * License: MIT License
 * Version: 2.0.4 (2016-05-23)
 */

/*global document, Popcharts */
(function (factory) {
    ...
    var addEvent = Popcharts.addEvent,
        each = Popcharts.each,
        pick = Popcharts.pick;
    ...
    Popcharts.Chart.prototype.callbacks.push(function (chart) {
        ...
        function mouseDown(e) {
            ...
            if ((originalEvent.target.getAttribute('class') || '').indexOf('Popcharts-handle') !== -1) {
     ...
     */
    Popcharts.seriesTypes.column.prototype.useDragHandle = function () {
        var is3d = this.chart.is3d && this.chart.is3d();
        return !is3d;
    };

    Popcharts.seriesTypes.column.prototype.dragHandlePath = function (shapeArgs, strokeW) {
        var x1 = shapeArgs.x,
            y = shapeArgs.y,
    ...
    Popcharts.wrap(Popcharts.seriesTypes.column.prototype, 'drawTracker', function (proceed) {
        var series = this,
