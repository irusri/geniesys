...
if ($baskettype == "gene") {
    ...
    $genelistresults = mysqli_query($mysqli_connection,$getgenelistsql) or die("query gagal dijalankan");
    ...
    $sampplelistresults = mysqli_query($mysqli_connection,$getsamplelistsql) or die("query gagal dijalankan");
    ...
    $golistresults = mysqli_query($mysqli_connection,$getgolistsql) or die("query gagal dijalankan");
