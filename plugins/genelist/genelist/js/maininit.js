...
$(document).ready(function() {
  ...
  $("#myInputTextField").keyup(function() {
    ...
    if ($("#myInputTextField").val().length == 0) {
      ...
      toastr.warning(
        "Please type some gene ids to search.",
  ...
  tblPrueba2 = $("#tblPrueba2").dataTable({
      ...
      aButtons: [
        ...
        /*{
          ...
          fnClick: function(nButton, oConfig) {
            ...
            for (i = 0; i < columns.length; i++) {
              columnsearch +=
                "&filter_" + i + "=" + encodeURIComponent(columns[i].sSearch);
            }
            var finalvar =
              $.param(oParams) +
              "&iDisplayLength=" +
              this.s.dt._iRecordsTotal +
              "&add_genes=true&id=" +
              $("#myInputTextField").val() +
              "&selected_genome=" +
              $("input[name=popr]:checked").val();
            ...
            $.ajax({
              ...
              success: function() {
                ...
                $(".checkboxSelector", tblPrueba2.fnGetNodes()).prop(
                  "checked",
                  true
                );
                selectboolean = true;
...

        {
          ...
          fnClick: function(nButton, oConfig) {
            ...
            var new_gene_list_name = prompt(
              "Please enter new Gene List name",
              "Complex"
            );
    ...
    fnDrawCallback: function() {
      ...
      var scrollHeadHeight = $dataTableWrapper
      ...
      if ($("#myInputTextField").val() == "") {
        ...
        if (
          ...
          if (invalid_boolean != true) {
            ...
            toastr.error(
              "Invalid input detected, please type in correct ids",
              "Invalid input"
            );
          ...
          if (
            ...
            if (old_number != oSettings._iRecordsDisplay) {
              ...
              toastr.success(
                "" + oSettings._iRecordsDisplay + " gene models found.",
                "Success"
              );
  ...
  if (
    init_flag == true &&
    typeof $_GET("table") == "undefined" &&
    typeof $_GET("_term") == "undefined"
  ) {
  ...
  $("#tblPrueba2 tbody tr td input").live("change", function(event) {
    var temp_gene_selecct_id = $(event.target)
      .parent()
      .parent()
      .find("tr").prevObject[0].childNodes[1].textContent;
